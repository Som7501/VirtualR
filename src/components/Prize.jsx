...
const Prize = () => {
  return (
    <div className="mt-20">
        ...
        text-center my-8 tracking-wider">
            Pricing
        </h2>
                ...
                <div key={index} className="w-full p-2 sm:w-1/2 lg:w-1/3">
                    <div className="p-10 border border-neutral-700 rounded-xl">
                        <p className="text-4xl mb-8">
                            {option.title}
                            {option.title === "Pro" && 
                            <span className="text-xl bg-linear-to-r from-orange-500
                             to-red-800 text-transparent bg-clip-text ml-2 mb-4">
                                (Most Popular)
                            </span>}
                        </p>
                        <p className="mb-8">
                        ...
                        <ul>
                            {option.features.map((feature,index)=>(
                                <li key={index} className="mt=8 flex items-center pb-6">
                                    <CheckCircle2/>
                        ...
                        w-full h-12 p-5 mt-15 tracking-tight text-xl hover:bg-orange-900
