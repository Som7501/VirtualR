...
const Navbar = () => {
  ...
  function toggleNavbar() {
    return setmobileDrawerOpen(!mobileDrawerOpen);
  }
  ...
  return (
    ...
    >
      <div className="container px-4 mx-auto relative text-sm">
        ...
        {mobileDrawerOpen && (
          <div
            className="fixed right-0 bg-neutral-900 w-full p-12
          ...
          >
            ...
            <div className="flex space-x-6">
              ...
              <a className="bg-linear-to-r from-orange-500 to-orange-800
                py-2 px-3 border rounded-md" href="#">
                Create Account
              </a>
            </div>
          </div>
